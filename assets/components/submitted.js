        ...
        <View style={{
                    ...
                    <View style={{
                        ...
                        marginLeft:14
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>File Submissions</Text>
                                 
                    </View>

                    </View>
        <View style={{width:2,height:170,backgroundColor:"#000000",marginTop:8}}></View>
        <View style={{
            flexDirection:"column"
        }}>
        <View style={{
                        ...
                        alignItems:"center"
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000"}}>One attempt</Text>
                    ...
                    <View style={{
                        ...
                        justifyContent:"space-between",
                        alignItems:"center",
                        backgroundColor:"#7EEFAB"


                    }}>
                                                <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000"}}>Graded</Text>
                    ...
                    <View style={{
                        ...
                        backgroundColor:"#7EEFAB"
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000"}}>File was submitted</Text>
                    ...
                    <View style={{
                        ...
                        alignItems:"center"
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000"}}>Shoaib Tariq Assignment.pdf</Text>
