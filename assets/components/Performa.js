      ...
      width:"100%"
        ...
        <View style={{
            ...
            <View style={{
                ...
                <View style={{justifyContent:"center",alignSelf:"center", backgroundColor:"#871B1B",width:955,height:"5%", marginLeft:60}}>
                    <Text style={{color:"#ffffff",fontSize:18,fontWeight:"bold",alignSelf:"center"}}>Student Result Card</Text>
                </View>
                <View style={{borderWidth:2,justifyContent:"center",alignSelf:"center", borderColor:"#AC0000",width:955,height:"29%",marginLeft:60}}>
                    ...
                    <View style={{
                        ...
                        <View style={{flexDirection:"column",
                            ...
                            fontWeight:"bold",
                            paddingBottom:10,
                            fontSize:22}}>Father Name  :  Tariq Malik</Text>
                        </View>
                        <View style={{
                            ...
                            fontWeight:"bold",
                            paddingBottom:10,
                            fontSize:22}}>Semester  :  Fall 2021</Text>
                    ...
                    <View style={{
                        ...
                        backgroundColor:"#8A1919"


                    }}>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#ffffff"}}>Course Code</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#ffffff"}}>Title</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#ffffff"}}>Credit Hrs</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#ffffff"}}>Marks</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#ffffff"}}>L.G</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#ffffff"}}>G.P</Text>
                    ...
                    <View style={{
                        ...
                        backgroundColor:"#D9D9D9"
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000",paddingRight:35}}>3</Text>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>92</Text>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>A</Text>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>4.00</Text>
                ...
                <View style={{
                    ...
                    <Text style={{
                        ...
                        The CGPA upto this semester is 3.44. The required CGPA required for the award of the degree is 2.2 .
                    </Text>
                </View>
                <View style={{width:955,height:3,backgroundColor:"#890505",marginTop:20,alignSelf:"center",marginLeft:60}}></View>
                <View style={{marginTop:20, borderWidth:2,justifyContent:"center",alignSelf:"center", borderColor:"#AC0000",width:955,height:"29%",marginLeft:60}}>
        ...
        <View style={{
            ...
            <Text style={{
                fontFamily:"Roboto",fontSize:22,fontWeight:"bold",color:"#ffffff",alignSelf:"center"
            }}> © 2021 - All rights reserved. • Powered by Emaan Institute of Management & Science</Text>
            </View>                   
