    ...
    return (
      ...
      flexDirection:"column"
        ...
        <View style={{
            ...
            <Text style={{color:"#B12A27",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:28,paddingTop:8}}>Announcement</Text>
            <View style={{marginTop:"5%"}}>
                                                                              <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:18,paddingTop:7}}>General News and Announcement</Text>
                                                                            
                                                                              <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:18,paddingTop:7}}>Quiz will be conducted April 6, 2023 </Text>
                                                                              <View style={{
                                                                                height:2,
                                                                                width:951,
                                                                                ...
                                                                                marginTop:5
                                                                                                                                                            ...
                                                                                                                                                            <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:18,paddingTop:7}}>No more Announcement yet. </Text>
