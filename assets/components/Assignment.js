...
const Assignment = props => {
    ...
    return (
      ...
      <Text style={{marginTop:10, color:"#B12A27",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:22,paddingTop:8}}>Submission Status</Text>
      <View style={{
        flexDirection:"row"
      }}>
        <View style={{
        ...
        <View style={{
                        ...
                        marginLeft:14,marginTop:10
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>Submission status</Text>
                    ...
                    <View style={{
                        ...
                        marginLeft:14
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>Grading status</Text>
                    ...
                    <View style={{
                        ...
                        marginLeft:14
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>Due date</Text>
                    ...
                    <View style={{
                        ...
                        marginLeft:14
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>Time remaining</Text>
                                 
                    </View>

                    </View>
        <View style={{width:2,height:136,backgroundColor:"#000000",marginTop:8}}></View>
        <View style={{
            flexDirection:"column"
        }}>
        <View style={{
                        ...
                        alignItems:"center"
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000"}}>No attempt</Text>
                    ...
                    <View style={{
                        ...
                        alignItems:"center"
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000"}}>No Graded</Text>
                    ...
                    <View style={{
                        ...
                        alignItems:"center"
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000"}}>Friday, 17 March 2023, 11:00 PM</Text>
                    ...
                    <View style={{
                        ...
                        alignItems:"center"
                                                ...
                                                <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000"}}>1 Day left</Text>
      ...
      onPress={() => Navigatetoassign1(props)}>
        <Text style={{fontFamily:"monospace",color:"#ffffff",fontSize:14,fontWeight:"bold",alignSelf:"center"}}>Add Submission</Text>
      </TouchableOpacity>
      <Text style={{fontFamily:"Roboto",fontSize:14,fontWeight:"bold",color:"#000000",alignSelf:"center",paddingTop:20}}>You have not made a submission Yet</Text>
