    ...
    return (
      ...
      flexDirection:"column"
        ...
        <View style={{flexDirection:"row",marginLeft:"5%",marginTop:20}}>
            <TouchableOpacity>
        <Text style={{marginLeft:10, fontFamily:"monospace",color:"#000000" ,fontSize:20,fontWeight:"bold"}}>This Course</Text>
        </TouchableOpacity>
        <View style={{width:2,height:30,backgroundColor:"#000000",marginLeft:5}}></View>
        <TouchableOpacity>
        <Text style={{marginLeft:10, fontFamily:"monospace",color:"#AC0000" ,fontSize:20,fontWeight:"bold"}}>All Courses</Text>
        </TouchableOpacity>
        ...
        <View style={{
                        ...
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#AC0000"}}>Course</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#AC0000"}}>Attendance</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#AC0000"}}>Taken Session</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#AC0000"}}>Points</Text>
                        <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#AC0000"}}>%age</Text>
                    ...
                    <View style={{
                        ...
                        <View style={{flexDirection:"column"}}>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>Applied</Text>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>Physics</Text>
                                                </View>
                                                <View style={{flexDirection:"column",marginRight:65}}>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000",paddingLeft:26}}>Attendance</Text>
                                                </View>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000",paddingRight:100}}>10</Text>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000",paddingRight:40}}>7/10</Text>
                                                <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000"}}>85%</Text>
                    ...
                    <Text style={{fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#AC0000",paddingRight:100}}>Average Attendance</Text>
                    <Text style={{paddingTop:5, fontFamily:"Roboto",fontSize:18,fontWeight:"bold",color:"#000000",paddingLeft:"70%"}}>85%</Text>
                    </View>
