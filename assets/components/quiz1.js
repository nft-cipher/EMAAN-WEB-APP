    ...
    return (
      ...
      flexDirection:"column"
        ...
        <View style={{
            ...
            <Text style={{color:"#B12A27",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:22,paddingTop:8}}>QUIZ 1</Text>
            <View style={{alignSelf:"center",alignItems:"center"}}>
                                                                              <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:18,paddingTop:7}}>Attempt allowed 1</Text>
                                                                            
                                                                              <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:18,paddingTop:7}}>This quiz will start on Saturday, 4 March 2021  </Text>
                                                                              <Text style={{color:"#AC0000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:18,paddingTop:7}}>Time Limit : 20 </Text>
                                                                 
      
      </View>
      <Text style={{marginTop:10, color:"#B12A27",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:22,paddingTop:62}}>Summary of your Previous Attempt</Text>
      <View style={{
            width:954,
            height:174,
            borderWidth:2,
            ...
            <View style={{flexDirection:"row"}}>
            <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:20,fontSize:18,paddingTop:7,marginLeft:20}}>State  </Text>
            <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:18,paddingTop:7,paddingLeft:"80%"}}>Review  </Text>
            ...
            <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:20,fontSize:18,paddingTop:7,marginLeft:20}}>Finished  </Text>
            <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:20,fontSize:18,paddingTop:7,marginLeft:20}}>Submitted Saturday, 4 March 2023, 1:19 PM  </Text>

            </View>
            <Text style={{color:"#000000",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:18,paddingTop:7,paddingLeft:"45%"}}>Not Permitted  </Text>
