      ...
      flexDirection:"column"
        ...
        <View style={{
            ...
            <View style={{
                ...
                <Text style={{color:"#890505",fontSize:18,fontWeight:"bold",marginTop:30,marginLeft:70}}>3rd Semester Fee Voucher</Text>
                <View style={{
                    flexDirection:"row",
            ...
            }}>Semester Fee Voucher.pdf</Text>
            </TouchableOpacity>
                </View>
                <Text style={{color:"#00000",fontSize:18,fontWeight:"bold",marginTop:30,marginLeft:70}}>Clear your current semester fee before deadline. University will charge late fee after the Due Date</Text>
