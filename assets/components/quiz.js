    ...
    return (
      ...
      flexDirection:"column"
        ...
        <View style={{
            ...
            <Text style={{color:"#B12A27",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:22,paddingTop:8}}>QUIZ</Text>
      ...
      onPress={() => Navigatetoquiz1(props)}
      >
        <Text style={{fontFamily:"monospace",color:"#ffffff",fontSize:14,fontWeight:"bold",alignSelf:"center"}}>Start Quiz</Text>
      </TouchableOpacity>
      
      
      </View>
      <Text style={{marginTop:10, color:"#B12A27",fontFamily:"Roboto",fontWeight:"bold",paddingLeft:14,fontSize:22,paddingTop:8}}>Summary of your Previous Attempt</Text>
      <View style={{
            width:954,
            height:174,
            borderWidth:2,
